...
import ModalBookingOnline from "./ModalBookingOnline";
...
function BookingOnline() {
  ...
  // const handleEdit = ([]) => {
  //   setModalBooking({ isShow: !modalBooking.isShow });
  // };
  ...
  return (
    <>
      {/* <div className="relative">
        {show ? <ModalBookingOnline show={show} setShow={setShow} /> : ""}

        {modalBooking.isShow ? <ModalBookingOnline setLoad={setLoad} setShow={setModalBooking} show={modalBooking.isShow} data={modalBooking} /> : ""}
      </div> */}
      <div>
            ...
            <tbody>
              <tr>
                ...
                <td className="flex gap-x-1 justify-center">
                  <button onClick={() => "handleEdit"([])} className="btnp">
                    <i className="bx bx-edit bx-sm text-inf2 bg-white"></i>
                  </button>
