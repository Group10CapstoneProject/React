      ...
      {detail && (
        <>
          <div className="w-full flex justify-between mb-5">
            ...
            <button onClick={() => navigate(`/editkelasonline`, { state: detail })} className="px-4 py-1 bg-prim rounded-lg text-white font-bold hover:bg-accent transition-all duration-200 ease-linear">
