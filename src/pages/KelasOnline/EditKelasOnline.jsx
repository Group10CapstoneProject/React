...
function EditKelasOnline() {
  ...
  const { id, title, link, price, description, online_class_category, tools, target_area, duration, level, picture, trainer } = state.state;
  console.log(state);
        ...
        <div className="flex flex-col gap-y-3">
          <div className="flex gap-x-5 w-full justify-between">
            ...
            <div className="flex flex-col w-1/2 gap-y-2">
              ...
              <select onChange={onChange} name="trainer_id" value={data.trainer_id} className="select-sm border w-full max-w-xs" defaultValue={trainer?.id}>
          ...
          <div className="flex flex-col w-full gap-y-4">
            ...
            <textarea type="text" placeholder="Deskripsi" className="input input-sm input-bordered w-full h-full" onChange={onChange} value={data.description} name="description" />
          </div>
