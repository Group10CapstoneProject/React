        ...
        <div className="grid grid-cols-3 gap-3 mt-5">
          {method &&
            method.map((m) => (
              <div
                key={m.id}
                className="  overflow-hidden flex items-center justify-center border-1 border-prim rounded-xl  shadow-xl w-72 h-42 py-2"
              >
                <div className="w-full h-full flex flex-col justify-between relative">
                  ...
                  <div className="flex justify-center w-full gap-x-2">
                    ...
                    <button
                      ...
                      className="px-2 py-1 rounded-lg cursor-pointer bg-dang text-white font-semibold active:scale-95 hover:bg-dang/80 transition-all duration-100 ease-linear"
                    >
                      Hapus
                    </button>
                  </div>
