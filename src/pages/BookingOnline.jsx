  ...
  return (
    <div>
        ...
        <table className="table table-compact w-full">
          ...
          <tbody>
            <tr>
              ...
              <td className="leading-none text-info font-bold">
                kelompok10@gmail.com
              </td>
              <td className="leading-none text-info font-bold">Gold</td>
              <td className="leading-none text-inf2 font-bold">
                Waiting Approval
              </td>
      ...
      <div className="flex justify-end btn-group">
        ...
        <button className="btn btn-outline hover:bg-prim3 text-black">
          ...
        </button>
        <button className="btn btn-outline hover:bg-prim3 text-black">
          10
